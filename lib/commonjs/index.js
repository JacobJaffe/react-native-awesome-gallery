...
exports.default = exports.snapPoint = exports.useVector = void 0;
...
const useVector = (x1 = 0, y1) => {
  ...
  const y = (0, _reactNativeReanimated.useSharedValue)(y1 !== null && y1 !== void 0 ? y1 : x1);
  return {
    x,
    y
  };
...
const ResizableImage = /*#__PURE__*/_react.default.memo(({
  ...
  const pinchGesture = _reactNativeGestureHandler.Gesture.Pinch().enabled(pinchEnabled).onStart(({
    ...
    if (onScaleStart) {
      (0, _reactNativeReanimated.runOnJS)(onScaleStart)(scale.value);
    }
  ...
  const doubleTapGesture = _reactNativeGestureHandler.Gesture.Tap().enabled(doubleTapEnabled).numberOfTaps(2).maxDelay(doubleTapInterval).onEnd(({
    ...
    if (onDoubleTap) {
      (0, _reactNativeReanimated.runOnJS)(onDoubleTap)(scale.value === 1 ? doubleTapScale : 1);
    }
